...
const defaultProvider = process.env.REACT_APP_INFURA_KEY;
...
const devConfig: Configuration = {
  ...
  baseLaunchDate: new Date('2020-11-29T18:00:00Z'),
  bondLaunchesAt: new Date('2020-12-05T18:00:00Z'),
  boardroomLaunchesAt: new Date('2020-12-11T18:00:00Z'),
